<?php
include '../conn.php';
$query=mysqli_query($conn,"SELECT * FROM laporan WHERE status='On-Going' ORDER BY no_laporan ASC");
  ...
  <div class="d-flex" id="wrapper">
    ...
    <div id="page-content-wrapper">
      ...
      <div class="container-fluid">
        <h1 class="mt-4 text-center">On-Going Reports</h1>
    ...
    <?php
      ...
      while($data=mysqli_fetch_array($query)){
        ...
        <tr>
          ...
          <td style="text-align: center" class="badge badge-info"><?php echo $data["status"]; ?></td>
        </tr>
